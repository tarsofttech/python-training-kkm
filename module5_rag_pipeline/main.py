"""
Module 5: Full RAG Pipeline - Main Application

This application demonstrates a complete RAG system with:
...
app = FastAPI(
    ...
    description="Full RAG Pipeline with FAISS - Semantic search and answer generation",
    lifespan=lifespan
)
...
async def root():
    ...
    return {
        ...
        "endpoints": {
            ...
            "query": "/api/v1/query",
            "debug_query": "/api/v1/debug/query",
...
async def get_status():
    ...
    Returns information about the index state, model configuration,
    and number of indexed documents.
    """
